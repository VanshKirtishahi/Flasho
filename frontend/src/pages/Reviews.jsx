    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1 font-medium">Monitor quality standards and professional feedback.</p>
        </div>
      ...
      {reviews.length === 0 ? (
        <div className="p-16 text-center bg-white rounded-2xl shadow-sm border border-gray-100">
          ...
          <p className="text-gray-500 font-bold">No reviews submitted yet.</p>
        </div>
      ) : (
            ...
            <div key={review._id} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
              ...
              <div className="bg-gray-50 p-4 rounded-xl mb-4 border border-gray-100">
                <p className="text-gray-700 text-sm leading-relaxed italic">
                  "{review.review_text && review.review_text.trim() !== '' ? review.review_text : 'The customer submitted a star rating without written feedback.'}"
                </p>
              </div>
              ...
              <div className="flex gap-4 pt-4 border-t border-gray-50">
                <div className="flex-1 flex items-center gap-2">
                  ...
                  <div className="overflow-hidden">
                    ...
                    <p className="text-sm font-semibold text-gray-800 truncate">{review.client_id?.full_name || 'Unknown'}</p>
                  </div>
                </div>

                <div className="flex-1 flex items-center gap-2 border-l border-gray-100 pl-4">
